  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 py-3 flex items-center shadow-sm">
        <Link href="/chat" className="text-gray-500 hover:text-gray-800 transition-all duration-150 p-2 -ml-2 rounded-full hover:bg-gray-100 active:scale-90 active:bg-gray-200">
