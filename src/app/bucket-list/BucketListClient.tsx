...
export default function BucketListClient({ initialItems }: { initialItems: BucketItem[] }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20">
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md sticky top-0 z-10 border-b border-gray-100 dark:border-gray-700 px-4 py-3 flex items-center shadow-sm">
        ...
        <h1 className="text-lg font-bold text-gray-800 dark:text-gray-100 ml-2">💘 恋爱清单</h1>
