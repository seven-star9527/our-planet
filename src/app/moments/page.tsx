...
export default async function MomentsPage({
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20">
      {/* Top navigation */}
      <div className="sticky top-0 z-20 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-700 px-4 py-3 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-gray-800 dark:text-gray-100">📸 时光手账</h1>
          {tag && (
